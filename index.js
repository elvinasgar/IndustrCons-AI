...
- Münasib olduqda IndustrCons WhatsApp Community-yə qoşulmağı təklif et, amma bunu hər cavabda təkrarlama.`;

// ---- TOOL ROUTER (deterministic — mirrors frontend/js/api-client.js _localFallback) ----
const INTENT_RULES = [
  { keywords: ["ncr", "uyğunsuzluq", "non-conformance"], module: "docs", url: "modules/docs/",
  ...
  { keywords: ["beton", "concrete", "tökəcəyik", "pour"], module: "cost-estimator", url: "modules/cost-estimator/",
  ...
  { keywords: ["qa/qc", "qa qc", "şablon", "template"], module: "docs", url: "modules/docs/",
